...
SECRET_KEY = 'django-insecure-8_j=0=_f)=49yzq4rz2k$v$v(juu!!%)+-jb#a2(bbp(etwq(h'
...
INSTALLED_APPS = [
    ...
    # INSTALLED APPS
    'django_celery_beat',     # for scheduling the tasks, will give list django modules, do migrate
